...
def test_post_wombats():
    ...
    def post(**kwargs):
        print("post enter")
        return requests.post('http://localhost:8080/wombats', data= {"name": "Charlie", "dob": "2005-11-26" } )#data = kwargs)
        #"id": 4, we send id also If we need else it will generate like auto incimentation
